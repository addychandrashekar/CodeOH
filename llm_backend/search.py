...
def search_code(user_id, query_embedding, match_threshold=0.5):
    """Search for the most relevant code snippets"""

    results = query_supabase_for_embeddings(user_id, query_embedding, match_threshold=match_threshold)
